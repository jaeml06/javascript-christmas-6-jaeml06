...
const OutputView = {
  ...
  printPreview(day = '') {
    Console.print(
      `${MESSAGE.eventMonth}${MESSAGE.month} ${day}${MESSAGE.preview}`,
    );
  },
  printMenu(order = []) {
  ...
  printChristmasDdayDiscount(price = 0) {
    if (price !== 0) {
      Console.print(
        `${MESSAGE.ChristmasDdayDisCount}${price.toLocaleString()}${
          MESSAGE.won
        }`,
      );
    }
  ...
  printWeekdayDiscount(price = 0) {
    if (price !== 0) {
      Console.print(
        `${MESSAGE.weekdayDiscount}${price.toLocaleString()}${MESSAGE.won}`,
      );
    }
  },
  printWeekendDiscount(price = 0) {
    if (price !== 0) {
      Console.print(
        `${MESSAGE.weekendDiscount}${price.toLocaleString()}${MESSAGE.won}`,
      );
    }
  },
  printSpecialDiscount(price = 0) {
    if (price !== 0) {
      Console.print(
        `${MESSAGE.specialDiscount}${price.toLocaleString()}${MESSAGE.won}`,
      );
    }
  },
